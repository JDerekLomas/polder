...
- attempt to misuse, attack, overload, reverse-engineer (except as permitted by mandatory law), or circumvent the security or access controls of the Service or its infrastructure;
- use the Service to generate malware, to facilitate illegal activity, or to produce content that violates the AI model provider's usage policies;
...
3.3 When you prompt the assistant, your prompt and relevant code/context are sent to an EU-hosted AI model provider to generate a response, as described in the Privacy Policy.
...
5.1 If you publish a project, its built output is stored on EU-based object storage (Scaleway, fr-par) and made available at a **public web address**. **Anything you publish is publicly accessible.** Do not publish content you do not have the right to make public, or that contains personal or confidential data.

5.2 We (or your institution) may remove published content that violates these Terms or applicable law.

---

## 6. Warranty disclaimer

6.1 The Service is provided **"as is" and "as available"**, without warranties of any kind, to the maximum extent permitted by law. We do not warrant that the Service will be uninterrupted, error-free, or secure, or that AI output will be accurate, fit for purpose, or non-infringing.

6.2 Nothing in these Terms excludes or limits rights you have under mandatory Dutch or EU consumer law that cannot lawfully be excluded.

> 🔖 **For counsel:** Mandatory Dutch/EU consumer-protection and product-liability law limits how far "as is" disclaimers and liability caps can go for natural persons. The disclaimer and Section 7 must be tailored to what is enforceable for student end-users in the Netherlands.
...
> 🔖 **For counsel:** The liability cap and carve-outs must be set and verified against Dutch law (incl. Art. 6:233 BW on unreasonably onerous terms in consumer contexts). The bracketed cap is a placeholder.
...
8.2 We or your institution may suspend or terminate your access if you breach these Terms, if required by the institution, or if your relationship with the institution ends.

8.3 On termination, your right to use the Service ends. Handling of your data after termination is described in the Privacy Policy and governed by the institution's instructions and our DPA.

---

## 9. Changes to the Service and these Terms

We may update the Service and these Terms. Material changes will be communicated through the application or by your institution. Continued use after changes take effect means you accept the updated Terms.

---

## 10. Governing law and jurisdiction

10.1 These Terms are governed by the **laws of the Netherlands**, without prejudice to mandatory consumer-protection rules of your country of residence within the EU.

10.2 Disputes are subject to the jurisdiction of the competent courts of [the Netherlands / the District Court of [CITY]], without prejudice to any mandatory consumer right to bring proceedings in your place of residence.

> 🔖 **For counsel:** Confirm the forum clause and ensure it respects mandatory EU consumer jurisdiction rules (Brussels I bis) for student end-users.
